...
To jest moduł host-auth dla systemów opartych na systemie
linux-vserver.

Moduł nss_vserver pozwala uwierzytelniać użytkowników z vserwerów na
hoście poprzez standardowe uwierzytelnianie PAM. Aby użytkownik
logował się do swojego vserwera przez host, należy także użyć nieco
